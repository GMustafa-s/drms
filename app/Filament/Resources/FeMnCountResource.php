...
use App\Filament\Resources\FeMnCountResource\Pages;
use App\Filament\Resources\FeMnCountResource\RelationManagers;
...
class FeMnCountResource extends Resource
{
    protected static ?string $model = FeMnCount::class;

    protected static ?string $label ='FE & MN Counts';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\DatePicker::make('sample_date')
                    ->native(false)
                    ->required(),
                Forms\Components\TextInput::make('chem_used')
//                    ->numeric()
                    ->required(),
...
//                    ->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('chem_used')
                    ->sortable()
                    ->sortable(),
    ...
    {
        return [
            'index' => Pages\ListFeMnCounts::route('/'),
            'create' => Pages\CreateFeMnCount::route('/create'),
            'edit' => Pages\EditFeMnCount::route('/{record}/edit'),
        ];
    }
