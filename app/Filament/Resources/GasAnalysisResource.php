...
use App\Filament\Resources\GasAnalysisResource\Pages;
use App\Filament\Resources\GasAnalysisResource\RelationManagers;
use App\Models\GasAnalysis;
use App\Models\Well;
...
class GasAnalysisResource extends Resource
{
    protected static ?string $model = GasAnalysis::class;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('co2')
                    ->numeric()
                    ->required(),
                Forms\Components\TextInput::make('h2s_ppm')
                    ->numeric()
                    ->required(),
...
//                    ->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('co2')
                    ->sortable()
                    ->sortable()
                    ->label('% CO2'),
                Tables\Columns\TextColumn::make('h2s_ppm')
                    ->sortable()
                    ->label('H2S PPM'),
    ...
    {
        return [
            'index' => Pages\ListGasAnalyses::route('/'),
            'create' => Pages\CreateGasAnalysis::route('/create'),
            'edit' => Pages\EditGasAnalysis::route('/{record}/edit'),
        ];
    }
