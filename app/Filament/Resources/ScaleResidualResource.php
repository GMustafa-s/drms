...
use App\Filament\Resources\ScaleResidualResource\Pages;
...
class ScaleResidualResource extends Resource
{
    protected static ?string $model = ScaleResidual::class;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('chem_used')
                    ->required(),
                Forms\Components\TextInput::make('po4')
                    ->numeric()
                    ->required(),
...
//                    ->required(),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('chem_used')
                    ->sortable()
                    ->label('Chemical Used'),
                Tables\Columns\TextColumn::make('po4')
                    ->sortable()
                    ->label('PO4'),
    ...
    {
        return [
            'index' => Pages\ListScaleResiduals::route('/'),
            'create' => Pages\CreateScaleResidual::route('/create'),
            'edit' => Pages\EditScaleResidual::route('/{record}/edit'),
        ];
    }
